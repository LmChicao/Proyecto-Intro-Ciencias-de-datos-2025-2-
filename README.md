...
# EDA
    ...
    Se aplico EDA a los 4 tipos de archivos Inscripcion, Matricula, Postulacion y Rendicion
    
    Nos realizamos un par de preguntas durante el proceso y las anotamos para responderas en el archivo 
    'EDA-RESPUESTAS.ipynb'

    Durante el proceso, tuvimos alguns problemas con la codificacion de los datos en las tablas de los archivos .xlsx
    donde al intentar pasarlos a un dataframe venian con errores, intentamos usar enconding('utf-8) y otas variantes pero el problema 
    no se soluciono, aun que, no afecta mucho ya ue logramos identificar las carreras, es mas un problema estetico

    Durante el proceso nos dimos cuenta que no podiamos responder todas las preguntas, 
